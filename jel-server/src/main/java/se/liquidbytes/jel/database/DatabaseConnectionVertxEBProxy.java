...
import java.util.ArrayList;import java.util.HashSet;import java.util.List;import java.util.Map;import java.util.Set;import io.vertx.core.json.JsonArray;
...
*/
public class DatabaseConnectionVertxEBProxy implements DatabaseConnection {

  private Vertx _vertx;
  private String _address;
  private boolean closed;

  public DatabaseConnectionVertxEBProxy(Vertx vertx, String address) {
    this._vertx = vertx;
  ...
  public DatabaseConnection getSite(String id, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "getSite");
  ...
  public DatabaseConnection getSites(Handler<AsyncResult<JsonArray>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    DeliveryOptions _deliveryOptions = new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getSites");
  ...
  public DatabaseConnection addSite(JsonObject document, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    DeliveryOptions _deliveryOptions = new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addSite");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
