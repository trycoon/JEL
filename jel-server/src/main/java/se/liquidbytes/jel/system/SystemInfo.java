...
public class SystemInfo {
    ...
    public static String getStartupInformation() {
        ...
        builder.append("IP Addresses: ").append(getIPAddress()).append("\n");
        builder.append("Gateway Addresses: ").append(getGatewayAddress()).append("\n");
        builder.append("==================================================").append("\n");
    ...
    public static JsonObject getSystemInformation() {
        ...
        hardware.put("ipAddress", getIPAddress());
        hardware.put("gatewayAddress", getGatewayAddress());
